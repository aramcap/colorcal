...
- Creación de etiquetas personalizadas con nombre y color. Tras cada una se propone
  un color nuevo al azar, alejado de los ya usados, para encadenar altas sin elegirlo;
  se puede cambiar antes de agregar.
